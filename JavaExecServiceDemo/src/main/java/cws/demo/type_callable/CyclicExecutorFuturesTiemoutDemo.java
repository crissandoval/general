...
public class CyclicExecutorFuturesTiemoutDemo {
	...
	public static void main(String[] args) {
		...
		CyclicExecutorFuturesTiemoutDemo executorFuturesTiemoutDemo = new CyclicExecutorFuturesTiemoutDemo();
	...
	private void setupExecAndRun(String[] args) {
		...
		for (int thread = 0; thread < NTHREADS; thread++) {
			futures.add(executor.submit(new CyclicBarrierTimeIntervalsTask(throwException, cyclicBarrier)));
		}
