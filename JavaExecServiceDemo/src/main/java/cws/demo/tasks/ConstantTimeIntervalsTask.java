...
public class ConstantTimeIntervalsTask implements Callable<Pair<Long, Long>> {
	 ...
	 */
	public ConstantTimeIntervalsTask(final Boolean throwException) {
